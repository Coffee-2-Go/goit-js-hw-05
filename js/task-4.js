...
const getTotalBalanceByGender = (users, gender) =>
  users
    .filter((user) => user.gender === gender) // відбираю користувачів за статтю
    .map((user) => user.balance) // отримую масив балансів
    .reduce((total, balance) => total + balance, 0); // повертаю загальний баланс користувачів
